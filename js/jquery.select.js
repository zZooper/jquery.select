(function($) {
    $.selectSuggest = function(target, data, itemSelectFunction) {
    		var defaulOption = {
    			...
    			itemBackgroundColor:'',//默认背景颜色
    			itemOverColor : 'rgb(255,255,255)',//选中字体颜色
    			itemOverBackgroundColor : 'rgb(30,144,255)',//选中背景颜色
        ...
        function() {
            ...
            $(document).ready(function(){
	            suggestContainerLeft = $('#' + target).offset().left;
	            suggestContainerTop = $('#' + target).offset().top + $('#' + target).outerHeight();
            });
